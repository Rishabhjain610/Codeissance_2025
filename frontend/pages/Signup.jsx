...
const FcGoogle = () => (
  ...
  >
    ...
    <path
      fill="#1976D2"
      d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.904,36.466,44,30.825,44,24C44,22.659,43.862,21.35,43.611,20.083z"
    ></path>
  </svg>
);
...
const HeartPulse = ({ className }) => (
  ...
  >
    ...
    <path d="M3.22 12H9.5l.5-1 2 4.5 2-7 1.5 3.5h5.28"></path>
  </svg>
);
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (backendRole === "Donor") backendRole = "NormalUser";
    if (backendRole === "Blood Bank") backendRole = "BloodBank";
    ...
    try {
      ...
      if (response.data.success) {
        ...
        } else if (response.data.user.role === "BloodBank") {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen bg-gray-100 py-4">
      <img
      ...
      <div className="relative w-full max-w-md p-6 bg-white rounded-xl shadow-2xl space-y-5 transition-all duration-300 transform hover:shadow-red-500/30">
        <div className="text-center">
          <Link
            to="/"
            className="inline-flex items-center text-3xl font-bold text-red-600 mb-2"
          >
